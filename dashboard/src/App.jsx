...
function FinancialsPanel({ order, onUpdated }) {
    ...
    <div>
      ...
      <div style={{ display: 'flex', gap: 40 }}>
        <div>
          ...
          <FinancialsPanel order={order} onUpdated={onUpdated} />
        </div>
        <div>
      ...
      {order.digital_pages_url && (
        <p><a href={order.digital_pages_url} target="_blank" rel="noreferrer">Digital pages folder (PDF pages, for Heyzine)</a></p>
      )}
    </div>
  );
}
