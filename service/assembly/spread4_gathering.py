...
LINEHEIGHT = 30 / 18
TEXT_BOX_H_MM = 30
BOTTOM_BUFFER_MM = 8  # distance from the true trim edge (pushed down further to clear the illustration)
...
LEFT_TEXT_BY_GENDER = {
    "girl": "Амьтад нэг нэгээрээ аяархан\nгишгэлсээр охины дэргэд хүрч ирэв.",
    "boy": "Амьтад нэг нэгээрээ аяархан\nгишгэлсээр хүүгийн дэргэд хүрч ирэв.",
}
...
def build_spread4(spread_path, out_path, gender):
    doc = fitz.open(spread_path)
    page = doc[0]
    insert_bottom_caption(page, LEFT_TEXT_BY_GENDER[gender], "left")
...
if __name__ == "__main__":
    build_spread4("/mnt/user-data/uploads/Spread_4_-_Gathering.pdf",
                  "/home/claude/amiyaa_test/spread4_test.pdf", "girl")
